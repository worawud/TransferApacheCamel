...
public class OrderService {
    ...
    public String processOrder(Order order) {
        ...
        return "Processed order id " + order.getId() + " item " + order.getItem() + " of " + order.getAmount() + " copies of " + order.getDescription()+" processxx" + order.isProcessed();
    }
    
//    public ArrayList<Order>  processOrder(ArrayList<Order> order) {
//    	logger.info("processOrder"+order.size());
